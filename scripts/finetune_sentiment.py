...
tmp = dataset['train'].train_test_split(test_size=0.11, seed=666)
train_dataset = tmp['train']
dev_dataset = tmp['test']
...
labels = labels
pred_labels = test_probs > 0.5
loss = bce_loss_numpy(test_probs, labels)
